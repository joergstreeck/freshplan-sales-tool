...
-- NOTE: CONCURRENTLY cannot be used in migrations, will create without it
CREATE UNIQUE INDEX IF NOT EXISTS ui_idk_tenant_key
...
COMMENT ON INDEX ui_idk_tenant_key IS
