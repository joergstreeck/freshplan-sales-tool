...
/**
 * Service for generating HTML exports that can be printed to PDF
 * This is a robust alternative to iTextPDF that works reliably in all environments
 * 
...
public class HtmlExportService {
     ...
     * This is a robust solution that works without external PDF libraries
     */
    public String generateCustomersHtml(ExportRequest request) {
        ...
        html.append("<button class=\"print-button no-print\" onclick=\"window.print()\">📄 Als PDF drucken</button>\n");
        ...
        if (request.getIndustry() != null) {
            html.append("<p><strong>Branche:</strong> ").append(escapeHtml(request.getIndustry())).append("</p>\n");
        }
        ...
        long activeCount = customers.stream()
            ...
            .count();
        long leadCount = customers.stream()
        ...
        for (Customer customer : customers) {
            ...
            html.append("  <td><strong>").append(escapeHtml(customer.getCompanyName())).append("</strong></td>\n");
            ...
            if (contactCount > 0) {
                ...
                CustomerContact primaryContact = customer.getContacts().stream()
                    .filter(c -> c instanceof CustomerContact && ((CustomerContact)c).getIsPrimary() != null && ((CustomerContact)c).getIsPrimary())
            ...
            if (customer.getLastContactDate() != null) {
                lastContact = customer.getLastContactDate()
        ...
        html.append("  <p>© 2025 FreshPlan Sales Tool - Generiert mit ❤️ für bessere Geschäftsbeziehungen</p>\n");
        html.append("  <p class=\"no-print\">Tipp: Nutzen Sie Strg+P (oder Cmd+P auf Mac) zum Drucken oder PDF-Export</p>\n");
        html.append("</div>\n");
