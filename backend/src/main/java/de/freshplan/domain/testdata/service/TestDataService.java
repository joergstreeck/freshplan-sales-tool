...
public class TestDataService {
   ...
   * 
   * This creates systematic test data to catch bugs early:
   * - String boundary tests (min/max lengths, special chars)
   * - Numeric edge cases (zero, max values, precision)
   * - Date/time edge cases (past, future, timezones)
  ...
  private List<Customer> createStringBoundaryTests() {
    ...
    Customer minimal = createTestCustomer(
        "MIN-001", 
    ...
    Customer maximal = createTestCustomer(
        "MAX-001",
        maxName,
        CustomerStatus.LEAD,
        LocalDateTime.now().minusDays(1),
    ...
    Customer special = createTestCustomer(
        "SPEC-001",
  ...
  private List<Customer> createNumericEdgeCases() {
    ...
    // Test 1: Zero values
    Customer zeroCustomer = createTestCustomer(
        "ZERO-001",
    ...
    Customer maxNumeric = createTestCustomer(
        "MAXNUM-001",
    ...
    maxNumeric.setExpectedAnnualVolume(new BigDecimal("9999999999.99")); // Max 10 Stellen + 2 Nachkomma
    ...
    Customer precise = createTestCustomer(
        "PREC-001",
  ...
  private List<Customer> createDateTimeEdgeCases() {
    ...
    // Test 1: Past dates
    Customer pastCustomer = createTestCustomer(
        "PAST-001",
    ...
    Customer futureCustomer = createTestCustomer(
        "FUTURE-001",
    ...
    Customer leapYear = createTestCustomer(
        "LEAP-001",
  ...
  private List<Customer> createBusinessLogicVariations() {
    ...
    Customer headquarter = createTestCustomer(
        "HQ-001",
    ...
    Customer filiale = createTestCustomer(
        "FIL-001",
    ...
    Customer highRisk = createTestCustomer(
        "RISK-HIGH",
    ...
    Customer lowRisk = createTestCustomer(
        "RISK-LOW",
  ...
  private List<Customer> createUnicodeTests() {
    ...
    Customer german = createTestCustomer(
        "UNI-DE",
    ...
    Customer french = createTestCustomer(
        "UNI-FR",
    ...
    Customer chinese = createTestCustomer(
        "UNI-CN",
    ...
    Customer emoji = createTestCustomer(
        "UNI-EMOJI",
    ...
    Customer punctuation = createTestCustomer(
        "UNI-PUNCT",
