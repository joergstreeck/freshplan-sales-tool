...
/**
 * DTO for updating an existing profile. All fields are optional - only provided fields will be
 * updated.
 *
...
public class UpdateProfileRequest {
  ...
  public static class Builder {
    ...
    public Builder financialInfo(CreateProfileRequest.FinancialInfo financialInfo) {
  ...
  public void setFinancialInfo(CreateProfileRequest.FinancialInfo financialInfo) {
