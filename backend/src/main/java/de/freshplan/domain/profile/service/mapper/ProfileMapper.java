...
public class ProfileMapper {
    ...
    public ProfileResponse toResponse(Profile profile) {
        return ProfileResponse.builder()
                ...
                .companyInfo(fromJson(profile.getCompanyInfo(), 
                        CreateProfileRequest.CompanyInfo.class))
                .contactInfo(fromJson(profile.getContactInfo(), 
                        CreateProfileRequest.ContactInfo.class))
                .financialInfo(fromJson(profile.getFinancialInfo(), 
                        CreateProfileRequest.FinancialInfo.class))
