 ...
 *
 * <p>This mapper handles the transformation of data between the domain layer (entities) and the
 * service layer (DTOs). It ensures that only appropriate data is exposed through the API.
 *
