 ...
 *
 * <p>This class is immutable and includes all updatable user fields. The ID is not included as it's
 * provided via the REST endpoint path.
 *
...
public final class UpdateUserRequest {
  ...
  @NotNull(message = "Enabled status is required") private final Boolean enabled;
