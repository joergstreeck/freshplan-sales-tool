...
/**
 * Exception thrown when attempting to create or update a user with
 * a username or email that already exists.
 * 
 * This is a runtime exception that should result in a 409 Conflict
 * HTTP response when thrown from a REST endpoint.
 * 
