 ...
 */
@Interceptor
@Auditable(eventType = null, entityType = "")
...
public class AuditInterceptor {
    ...
    public Object auditMethod(InvocationContext context) throws Exception {
        ...
        try {
            ...
            try {
                AuditContext failureContext = AuditContext.builder()
    ...
    private UUID extractEntityId(Object[] params, int paramIndex) {
        ...
        if (param instanceof UUID) {
            ...
            try {
                ...
                log.warn("Failed to parse UUID from string: {}", param);
                return null;
            }
        } else if (param != null) {
    ...
    private static final Map<String, Object> Map = java.util.Map;
}