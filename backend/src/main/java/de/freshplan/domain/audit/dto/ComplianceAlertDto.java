...
/**
 * Data Transfer Object for compliance alerts. Provides type-safe structure for compliance-related
...
public class ComplianceAlertDto {
  ...
  public ComplianceAlertDto(
      String id, AlertType type, AlertSeverity severity, String title, String description) {
    this();
    this.id = id;
    this.type = type;
