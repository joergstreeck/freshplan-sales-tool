 ...
 * 
 * Ermöglicht flexible Budget-Kontrolle auf Service- und Feature-Ebene
 */
@Entity
...
public class BudgetLimit extends PanacheEntityBase {
    ...
    public static BudgetLimit createServiceLimit(String service, BudgetPeriod period, BigDecimal amount) {
        return new BudgetLimit("service", service, period, amount);
    }

    public static BudgetLimit createFeatureLimit(String feature, BudgetPeriod period, BigDecimal amount) {
    ...
    public String toString() {
        return String.format("BudgetLimit{scope='%s', scopeValue='%s', period=%s, limit=%s}", 
