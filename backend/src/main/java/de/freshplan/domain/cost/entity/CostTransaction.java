 ...
 * 
 * Entspricht der Cost Management Architektur für präzise Kostenverfolgung
 * von externen Services wie OpenAI, Anthropic, etc.
 */
@Entity
...
public class CostTransaction extends PanacheEntityBase {
    ...
    // Factory Methods
    public static CostTransaction startTransaction(String service, String feature, String model, BigDecimal estimatedCost) {
    ...
    public String toString() {
        return String.format("CostTransaction{id=%s, service='%s', feature='%s', model='%s', estimatedCost=%s, actualCost=%s, status=%s}", 
