        ...
        public static class Builder {
            ...
            public FeatureAnalytics build() {
                return new FeatureAnalytics(
                    feature, contentCount, totalViews, totalFeedback,
                    averageHelpfulness, helpRequests, struggleDetections,
                    strugglesPerRequest, lastUpdated
                );
            }
        }
    }
    ...
    public static class Builder {
        ...
        public HelpAnalytics build() {
            return new HelpAnalytics(
                totalViews, totalFeedback, overallHelpfulnessRate,
                mostRequestedTopics, mostHelpfulContent, contentNeedingImprovement,
                featureCoverage, coverageGaps, helpRequestsByFeature,
                struggleDetectionsByType, averageResponseTime, userSatisfactionScore
            );
        }
    }
}