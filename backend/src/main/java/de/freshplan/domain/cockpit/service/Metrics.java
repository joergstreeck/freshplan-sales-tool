...
/**
 * Optimierter Metrics Collector mit effizienter Meter-Cache-Verwaltung.
 * Exponiert Metriken nach /q/metrics für Prometheus.
 *
 * Sprint 2.1.1 P0 HOTFIX - Performance-optimierte Micrometer-Nutzung
 */
@ApplicationScoped
public class Metrics {
    ...
    public void incPublishedWithResult(String type, String module, String result) {
        ...
        publishedCounters.computeIfAbsent(tags, t ->
    ...
    public void incConsumedWithResult(String type, String module, String result) {
        Tags tags = Tags.of("event_type", type, "module", module, "result", result);
        consumedCounters.computeIfAbsent(tags, t ->
    ...
    public void observeLatency(String type, String path, Duration d) {
        ...
        latencyTimers.computeIfAbsent(tags, t ->
