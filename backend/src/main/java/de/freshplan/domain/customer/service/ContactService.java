 ...
 * Handles business logic for multi-contact support, primary contact management,
 * and audit trail through Hibernate Envers.
 */
@ApplicationScoped
@Transactional
public class ContactService {
    ...
    public ContactDTO updateContact(UUID contactId, ContactDTO contactDTO) {
        Contact contact = contactRepository.findByIdOptional(contactId)
    ...
    public boolean isEmailInUse(String email, UUID excludeContactId) {
        ...
        return contacts.stream()
            .anyMatch(c -> !c.getId().equals(excludeContactId));
    }
}