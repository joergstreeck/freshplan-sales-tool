...
/**
 * Request DTO for calculating customer sales potential. Includes industry and service offerings for
...
public class PotentialCalculationRequest {
  ...
  @NotNull(message = "Industry is required for potential calculation") private String industry;
