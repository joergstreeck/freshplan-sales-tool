...
public record CreateCustomerRequest(
        ...
        @Size(max = 100, message = "Legal form must not exceed 100 characters")
        String legalForm,
        ...
        @Future(message = "Next follow-up date must be in the future")
    ...
    public static class Builder {
        ...
        public CreateCustomerRequest build() {
            return new CreateCustomerRequest(
                    companyName, tradingName, legalForm, customerType, industry,
                    classification, parentCustomerId, hierarchyType, status,
                    lifecycleStage, expectedAnnualVolume, actualAnnualVolume,
                    paymentTerms, creditLimit, deliveryCondition,
