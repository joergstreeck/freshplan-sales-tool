...
/**
 * ContactInteraction entity for tracking all interactions with contacts.
 * Part of the Data Strategy Intelligence feature to enable warmth scoring,
...
public class ContactInteraction extends PanacheEntityBase {
    ...
    public boolean isOverdue() {
        return nextActionDate != null && 
               nextActionDate.isBefore(LocalDateTime.now());
    }
