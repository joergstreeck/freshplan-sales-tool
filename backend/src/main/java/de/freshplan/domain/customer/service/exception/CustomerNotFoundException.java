...
/**
 * Exception thrown when a customer cannot be found. This exception indicates that a requested
 * customer does not exist or is not accessible in the current context.
 *
