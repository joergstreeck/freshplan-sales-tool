...
/**
 * Service for generating unique customer numbers in the format KD-YYYY-XXXXX.
 * Thread-safe implementation to ensure no duplicate numbers are generated.
 * 
 * Examples:
 * - KD-2025-00001
 * - KD-2025-00234
 * - KD-2026-00001 (resets each year)
 * 
...
public class CustomerNumberGeneratorService {
    ...
    /**
     * Generates the next available customer number for the current year.
     * Format: KD-YYYY-XXXXX
     * 
     * This method is thread-safe using ReentrantLock to prevent duplicate numbers
    ...
    /**
     * Generates a customer number for a specific year.
     * Mainly used for testing or data migration purposes.
     * 
