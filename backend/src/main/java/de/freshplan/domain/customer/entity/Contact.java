...
/**
 * Contact entity representing a person associated with a customer.
 * Supports multiple contacts per customer with primary/secondary designation,
 * location assignment, and relationship data for sales excellence.
 */
@Entity
@Table(name = "contacts",
    indexes = {
