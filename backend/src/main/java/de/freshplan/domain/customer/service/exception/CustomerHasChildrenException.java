...
/**
 * Exception thrown when attempting to perform an operation on a customer that has child customers,
 * and the operation is not allowed. This typically occurs during delete or merge operations.
 *
...
public class CustomerHasChildrenException extends RuntimeException {
  ...
  public CustomerHasChildrenException(UUID customerId, String operation) {
    super("Cannot " + operation + " customer " + customerId + " because it has child customers");
