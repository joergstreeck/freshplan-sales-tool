...
/**
 * Customer contact entity representing individual contacts within a customer organization.
 * Supports role-based access, hierarchy, and comprehensive contact information.
 * 
...
public class CustomerContact extends PanacheEntityBase {
    ...
    private void updateDecisionMakerStatus() {
        this.isDecisionMaker = roles.stream()
                .anyMatch(role -> Boolean.TRUE.equals(role.getIsDecisionMakerRole()));
    }
