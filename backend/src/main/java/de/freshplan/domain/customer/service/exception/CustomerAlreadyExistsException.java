...
/**
 * Exception thrown when attempting to create a customer that already exists. This exception
 * indicates that a customer with the same identifying characteristics (e.g., company name) already
