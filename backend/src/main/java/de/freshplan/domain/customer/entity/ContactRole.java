...
/**
 * Contact role entity representing different roles a contact can have.
 * Examples: CEO, CTO, Procurement Manager, Decision Maker, etc.
 * 
 * @author FreshPlan Team
 * @since 2.0.0
 */
@Entity
@Table(name = "contact_roles", indexes = {
    @Index(name = "idx_contact_role_name", columnList = "role_name", unique = true)
})
public class ContactRole extends PanacheEntityBase {
    ...
    public String toString() {
        return "ContactRole{" +
                ...
                ", isDecisionMakerRole=" + isDecisionMakerRole +
