...
/**
 * DTO for customer chain structure information.
 * Represents the distribution of locations across different regions.
 * 
 * @since 2.0.0
 */
public class ChainStructureDto {
    ...
    public boolean isValid() {
        ...
        int sum = (locationsGermany != null ? locationsGermany : 0) +
