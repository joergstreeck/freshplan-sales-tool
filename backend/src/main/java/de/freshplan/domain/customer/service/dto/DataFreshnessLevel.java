 ...
 * progressive Datenqualitätsbewertung.
 */
public enum DataFreshnessLevel {
    
    /**
     * Fresh - weniger als 90 Tage alt.
     * Grün - Alles gut, keine Aktion erforderlich.
     */
    FRESH("< 90 Tage", "fresh", "success", 90),
    
    /**
     * Aging - 90-180 Tage alt.
     * Gelb - Hinweis anzeigen, bald aktualisieren.
     */
    AGING("90-180 Tage", "aging", "warning", 180),
    
    /**
     * Stale - 180-365 Tage alt.
     * Orange - Update empfohlen.
     */
    STALE("180-365 Tage", "stale", "warning", 365),
    
    /**
     * Critical - über 365 Tage alt.
