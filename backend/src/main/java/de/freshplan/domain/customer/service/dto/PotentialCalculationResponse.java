...
/**
 * Response DTO for customer sales potential calculation. Includes monthly/yearly potential and
...
public class PotentialCalculationResponse {
  ...
  public PotentialCalculationResponse(BigDecimal monthlyPotential, BigDecimal yearlyPotential) {
