...
/**
 * Query Service for Customer domain following CQRS pattern. Handles all read operations (queries).
 *
 ...
 *
 * <p>NO WRITE OPERATIONS - This is a READ-ONLY service!
 */
@ApplicationScoped
public class CustomerQueryService {
  ...
  /**
   * Retrieves a customer by ID. EXACT COPY from CustomerService.getCustomer() - line 129
   *
  ...
  /**
   * Gets all customers with pagination. EXACT COPY from CustomerService.getAllCustomers() - line
   * 309
   */
  ...
  /**
   * Filters customers by status. EXACT COPY from CustomerService.getCustomersByStatus() - line 329
   */
  ...
  /** Gets customers at risk. EXACT COPY from CustomerService.getCustomersAtRisk() - line 417 */
  ...
  /**
   * Gets customers with overdue follow-ups. EXACT COPY from CustomerService.getOverdueFollowUps() -
   * line 429
   */
  ...
  /**
   * Checks for potential duplicates. EXACT COPY from CustomerService.checkDuplicates() - line 476
   */
  ...
  /** Gets dashboard statistics. EXACT COPY from CustomerService.getDashboardData() - line 580 */
