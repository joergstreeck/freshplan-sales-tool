...
/**
 * Customer timeline event entity representing all activities and changes related to a customer.
 * Provides comprehensive audit trail and activity history.
 *
...
public class CustomerTimelineEvent extends PanacheEntityBase {
   ...
   * When true, this timeline event can be deleted by clean-test-data scripts.
   */
  ...
  public long getEventAgeInDays() {
    return java.time.temporal.ChronoUnit.DAYS.between(
        eventDate.toLocalDate(), LocalDateTime.now().toLocalDate());
  }
  ...
  public static CustomerTimelineEvent createCommunicationEvent(
      Customer customer, String channel, String direction, String description, String performedBy) {
