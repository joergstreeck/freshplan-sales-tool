...
/**
 * LeadContact entity - 100% PARITY mit Contact.java (Customer Module).
 *
 * <p>Represents a contact person associated with a lead. Supports:
 *
 * <ul>
 *   <li>Multi-Contact Support: Multiple contacts per lead (N:1 relationship)
 *   <li>Primary Contact: One primary contact per lead (enforced by unique constraint)
 *   <li>CRM Intelligence: warmth_score, data_quality_score, relationship data
 *   <li>Backward Compatibility: Syncs primary contact to leads.contact_person via trigger
 * </ul>
 *
 * <p><b>Architektur-Entscheidung:</b> ADR-007 Option C (100% Parity with customer_contacts)
 *
 * <p><b>Migration:</b> V275 (create table) + V276 (backward compatibility trigger)
 *
 * @see Contact Contact.java (Customer Module) - Identische Feldstruktur
 * @see de.freshplan.modules.leads.domain.Lead Lead.contacts relationship
 */
@Entity
@Table(
    name = "lead_contacts",
    indexes = {
      ...
      @Index(name = "idx_lead_contacts_primary", columnList = "lead_id, is_primary"),
      @Index(name = "idx_lead_contacts_active", columnList = "is_active"),
      @Index(name = "idx_lead_contacts_email", columnList = "email"),
      @Index(name = "idx_lead_contacts_deleted", columnList = "is_deleted")
    })
public class LeadContact extends PanacheEntityBase {
  ...
  // ===========================
  // Basic Info (IDENTICAL to Contact.java lines 42-58)
  // ===========================
  ...
  // ===========================
  // Contact Info (IDENTICAL to Contact.java lines 60-68)
  // ===========================
  ...
  // ===========================
  // Flags (IDENTICAL to Contact.java lines 70-75)
  // ===========================
  ...
  // ===========================
  // Relationship Data - CRM Intelligence (IDENTICAL to Contact.java lines 82-96)
  // ===========================
  ...
  // ===========================
  // Intelligence Data - Sales Excellence (IDENTICAL to Contact.java lines 98-109)
  // ===========================
  ...
  // ===========================
  // Data Quality & Freshness (IDENTICAL to Contact.java lines 111-116)
  // ===========================
  ...
  // ===========================
  // Legacy Compatibility (IDENTICAL to Contact.java lines 118-123)
  // ===========================
  ...
  // ===========================
  // Audit Fields (IDENTICAL to Contact.java lines 125-138)
  // ===========================
  ...
  // ===========================
  // Business Methods (IDENTICAL to Contact.java lines 394-421)
  // ===========================

  /**
   * Returns full name with title if present.
   *
   * <p>Example: "Dr. Max Mustermann"
   */
  ...
  /**
   * Returns display name with salutation if present.
   *
   * <p>Example: "Herr Dr. Max Mustermann"
   */
  public String getDisplayName() {
    StringBuilder sb = new StringBuilder();
    if (salutation != null && !salutation.isBlank()) {
      String salutationDisplay = getSalutationDisplay();
      if (!salutationDisplay.isEmpty()) {
        sb.append(salutationDisplay).append(" ");
      }
    }
  ...
  // ===========================
  // Builder Pattern (IDENTICAL to Contact.java lines 423-469)
  // ===========================
