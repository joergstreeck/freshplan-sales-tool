 ...
 * 
 * Zentrale Behandlung aller IllegalArgumentException mit spezifischer 
 * Behandlung für verschiedene Fehlertypen:
 * - Enum parsing errors
 * - UUID parsing errors  
 ...
 */
@Provider
public class IllegalArgumentMasterExceptionMapper implements ExceptionMapper<IllegalArgumentException> {

    private static final Logger logger = Logger.getLogger(IllegalArgumentMasterExceptionMapper.class.getName());
