...
/**
 * JAX-RS Exception Mapper for CustomerAlreadyExistsException. Maps CustomerAlreadyExistsException
 * to HTTP 409 Conflict responses with consistent error format.
 *
  ...
  public Response toResponse(CustomerAlreadyExistsException exception) {
    ...
    Map<String, Object> errorResponse =
        Map.of(
            ...
            409,
            "conflictingField",
            exception.getConflictingField() != null ? exception.getConflictingField() : "unknown",
            "conflictingValue",
            exception.getConflictingValue() != null ? exception.getConflictingValue() : "unknown");
