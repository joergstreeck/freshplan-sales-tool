 ...
 *
 * <p>This class provides a consistent error response format across all API endpoints, making it
...
public final class ErrorResponse {
  ...
  public ErrorResponse(
      int status, String error, String message, String path, List<FieldError> violations) {
