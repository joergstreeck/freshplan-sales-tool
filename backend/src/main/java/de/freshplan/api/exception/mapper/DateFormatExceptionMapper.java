 ...
 *
 * <p>Behandelt DateTimeParseException und IllegalArgumentException die durch ungültige
 * Datumsformate entstehen, wie z.B. "Unsupported date format: invalid-date"
 *
