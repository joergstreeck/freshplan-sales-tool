...
public class ProfileResource {
    ...
    public Response getProfileByCustomerId(
            @PathParam("customerId") String customerId) {
        ProfileResponse response = profileService
                .getProfileByCustomerId(customerId);
        return Response.ok(response).build();
    }
    ...
    @PUT
    @Path("/{id}")
    public Response updateProfile(@PathParam("id") UUID id, 
    ...
    @HEAD
    @Path("/customer/{customerId}")
    public Response checkProfileExists(
            @PathParam("customerId") String customerId) {
    ...
    public Response exportProfilePdf(@PathParam("id") UUID id) {
        ...
        return Response.ok(pdfContent)
                .header("Content-Disposition", 
                        "attachment; filename=\"profile-" + id + ".pdf\"")
                .build();
    }
}