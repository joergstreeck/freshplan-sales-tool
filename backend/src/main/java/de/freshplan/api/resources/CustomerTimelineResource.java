...
/**
 * REST endpoint for managing customer timeline events.
 * Provides comprehensive API for timeline history and activities.
 * 
...
public class CustomerTimelineResource {
    ...
    @GET
    @Operation(summary = "Get customer timeline", 
    ...
    public Response getTimeline(
            ...
            @Parameter(description = "Filter by event category")
        ...
        TimelineListResponse timeline = timelineService.getCustomerTimeline(
                customerId, page, size, category, search);
    ...
    public Response createEvent(
            ...
            @Parameter(description = "Timeline event data", required = true)
    ...
    @Operation(summary = "Create note", 
              description = "Creates a quick note for a customer")
    @APIResponses({
        @APIResponse(responseCode = "201", 
    ...
    public Response createCommunication(
            ...
            @Parameter(description = "Communication data", required = true)
            @Valid @NotNull CreateCommunicationRequest request) {
        
        LOG.infof("Creating communication for customer %s", customerId);
        
        TimelineEventResponse communication = timelineService.createCommunication(
                customerId, request);
    ...
    @GET
    @Path("/follow-ups")
    @Operation(summary = "Get follow-up events", 
    ...
    @Operation(summary = "Get recent communications", 
    ...
    public Response getRecentCommunications(
        ...
        LOG.infof("Getting recent communications for customer %s (last %d days)", 
                customerId, days);
        
        List<TimelineEventResponse> communications = timelineService
                .getRecentCommunications(customerId, days);
    ...
    @GET
    @Path("/summary")
    @Operation(summary = "Get timeline summary", 
    ...
    @PUT
    @Path("/events/{eventId}")
    @Operation(summary = "Update timeline event", 
              description = "Updates an existing timeline event")
    @APIResponses({
        @APIResponse(responseCode = "200", 
    ...
    public Response completeFollowUp(
            ...
            @QueryParam("completedBy") @NotNull String completedBy) {
    ...
    @Operation(summary = "Delete timeline event", 
              description = "Soft deletes a timeline event")
    @APIResponses({
        @APIResponse(responseCode = "204", 
    ...
    public Response deleteEvent(
            ...
            @Parameter(description = "User who deleted the event")
            @QueryParam("deletedBy") @NotNull String deletedBy) {
