...
/**
 * REST API für Reality Check Integration Ermöglicht es anderen Tools, Reality Checks durchzuführen
 */
...
public class RealityCheckResource {
  ...
  public Response autoFix(@PathParam("featureCode") String featureCode, FixRequest fixRequest) {
