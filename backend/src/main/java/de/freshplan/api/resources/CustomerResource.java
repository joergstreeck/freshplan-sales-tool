 ...
 * Provides comprehensive CRUD operations, search, analytics, and hierarchy management.
 * 
...
public class CustomerResource {
    ...
    public Response addChildCustomer(
            @PathParam("parentId") UUID parentId,
            AddChildCustomerRequest request) {
        
        // TODO: Extract user from JWT when security is implemented
        String updatedBy = "system"; // Fallback for dev mode
        
        CustomerResponse child = customerService.addChildCustomer(
            parentId, 
            request.childId(), 
            updatedBy
        );
    ...
    public Response mergeCustomers(
            ...
            @Valid MergeCustomersRequest request) {
    ...
    public Response changeCustomerStatus(
        ...
        CustomerResponse customer = customerService.changeStatus(
            id, 
            request.newStatus(), 
            updatedBy
        );
