...
/**
 * Generic export REST endpoint using Universal Export Framework.
 * This replaces the old ExportResource with a unified implementation.
 * 
...
@ApplicationScoped
@Authenticated
@Tag(name = "Universal Export", description = "Unified export endpoints using Universal Export Framework")
public class GenericExportResource {
    ...
    private List<AuditEntry> fetchAuditData(String entityType, UUID entityId, 
            String from, String to, String userId, String eventType) {
