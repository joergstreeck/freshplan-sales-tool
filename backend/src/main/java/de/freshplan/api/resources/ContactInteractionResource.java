...
@Tag(name = "Contact Interactions", description = "Manage contact interactions and intelligence metrics")
public class ContactInteractionResource {
    ...
    @Inject
    DataHygieneService dataHygieneService;
    ...
    public Response createNote(
            ...
            String note,
            @Parameter(description = "User creating the note")
    ...
    public Response batchImport(List<ContactInteractionDTO> interactions) {
        ...
        return Response.ok()
                .entity(new ImportResult(imported, failed))
                .build();
    }
