...
public class DataQualityResource {
    ...
    @Operation(
        ...
        description = "Returns comprehensive data quality metrics including freshness, completeness, and coverage"
    )
    @APIResponses({
        @APIResponse(
            responseCode = "200",
    ...
    public Response getDataQualityMetrics() {
        ...
        try {
            ...
            // Critical gaps
            metrics.setCriticalDataGaps(Arrays.asList(
            ...
            metrics.setImprovementSuggestions(Arrays.asList(
            ...
            LOG.infof("Data quality metrics: Overall=%s, Completeness=%.1f%%, Coverage=%.1f%%",
