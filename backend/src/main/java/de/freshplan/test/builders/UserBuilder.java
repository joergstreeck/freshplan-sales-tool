 ...
 * Provides fluent API for setting user properties and predefined roles.
 * 
 * This builder ensures all test users are identifiable through their
 * username prefix since the User entity doesn't have an isTestData field.
 * 
...
public class UserBuilder {
    ...
    /**
     * Builds a User entity WITHOUT persisting to database.
    ...
    /**
     * Builds and persists a User entity to the database.
