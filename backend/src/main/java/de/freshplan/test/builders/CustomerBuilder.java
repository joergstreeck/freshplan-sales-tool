...
/**
 * Builder for creating test Customer entities.
 * Provides fluent API for setting customer properties and predefined scenarios.
 * 
 * This builder is part of the centralized test data architecture,
 * ensuring all test customers are properly marked and can be cleaned up.
 * 
...
public class CustomerBuilder {
    ...
    /**
     * Builds a Customer entity WITHOUT persisting to database.
    ...
    public Customer build() {
        ...
        customer.setTotalLocationsEU(
            locationsGermany + locationsAustria + 
            locationsSwitzerland + locationsRestEU
        );
    ...
    /**
     * Builds and persists a Customer entity to the database.
