...
/**
 * Service zur Überwachung und Generierung von Compliance-Alerts
 * für das Audit-System gemäß DSGVO-Anforderungen.
 */
@ApplicationScoped
public class ComplianceService {
  ...
  public List<ComplianceAlertDto> getComplianceAlerts() {
    ...
    long missingRetention = auditRepository.count("isDsgvoRelevant = true AND retentionUntil IS NULL");
    ...
    if (!"VALID".equals(integrityStatus)) {
      alerts.add(new ComplianceAlertDto(
          AlertType.ERROR,
          "Hash-Chain Integrität muss überprüft werden",
          Severity.CRITICAL
      ));
    }
  ...
  public boolean isCompliant() {
    ...
    return alerts.stream().noneMatch(alert -> 
