...
/**
 * Central UUID validation filter that runs early in the request pipeline. Prevents invalid UUIDs
 * from reaching the database layer.
 *
 * <p>This filter runs BEFORE authentication to fail-fast on invalid UUIDs.
 */
@Provider
