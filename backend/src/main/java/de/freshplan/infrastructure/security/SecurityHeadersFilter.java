...
/**
 * Security Headers Filter for Sprint 1.3 Security Gates. Adds security-relevant HTTP headers to all
 * responses. Part of FP-231: Security Gates Enforcement.
 */
@Provider
@Priority(2000)
public class SecurityHeadersFilter implements ContainerResponseFilter {
  ...
  public void filter(
    ...
    headers.putSingle("Permissions-Policy", "geolocation=(), microphone=(), camera=(), payment=()");
  ...
  private boolean isHttpsRequest(ContainerRequestContext requestContext) {
    ...
    return "https".equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(xForwardedProto);
  }
}
