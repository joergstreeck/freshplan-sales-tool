...
/**
 * CSV export strategy implementation. Generates CSV files with proper escaping and UTF-8 BOM for
 * Excel compatibility.
 *
...
public class CsvExporter implements ExportStrategy {
  ...
  private void writeDataRow(
      BufferedWriter writer, Object record, List<ExportConfig.FieldConfig> fields)
      throws Exception {
    boolean first = true;
    for (ExportConfig.FieldConfig field : fields) {
      if (!first) {
