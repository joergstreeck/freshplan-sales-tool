...
/**
 * Configuration for export operations. Defines what fields to export, how to format them, and
 * export options.
 *
...
public class ExportConfig {
  ...
  private ExportConfig(Builder builder) {
    ...
    this.styles = builder.styles != null ? builder.styles : ExportStyles.defaultStyles();
  ...
  public List<FieldConfig> getVisibleFields() {
    return fields.stream().filter(FieldConfig::isVisible).toList();
  }
  ...
  public static class FieldConfig {
    ...
    private FieldConfig(Builder builder) {
      ...
      this.defaultValue = builder.defaultValue != null ? builder.defaultValue : "";
      this.sortable = builder.sortable;
      this.alignment =
          builder.alignment != null ? builder.alignment : getDefaultAlignment(this.type);
    }
