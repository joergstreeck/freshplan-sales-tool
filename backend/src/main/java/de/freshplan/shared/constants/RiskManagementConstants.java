 ...
 * 
 * <p>These thresholds determine when customers are flagged as at-risk
 * based on days since last contact or other risk indicators.
 */
public final class RiskManagementConstants {
    
    /**
     * Low risk threshold in days.
     * Customers not contacted within this period are considered low risk.
     */
    public static final int RISK_THRESHOLD_LOW_DAYS = 60;
    
    /**
     * Medium risk threshold in days.
     * Customers not contacted within this period are considered medium risk.
     */
    public static final int RISK_THRESHOLD_MEDIUM_DAYS = 90;
    
    /**
     * High risk threshold in days.
     * Customers not contacted within this period are considered high risk.
     */
