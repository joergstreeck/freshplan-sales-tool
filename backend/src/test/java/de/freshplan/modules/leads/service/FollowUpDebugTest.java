...
class FollowUpDebugTest {
    ...
    void debugFollowUpCandidates() {
        ...
        var candidates = em.createQuery(
            ...
            "AND l.clockStoppedAt IS NULL", Lead.class)
        ...
        for (Lead l : candidates) {
            System.out.println(" - Lead ID: " + l.id + ", Company: " + l.companyName +
                              ", Status: " + l.status + ", Registered: " + l.registeredAt);
        }

        // Check templates
        var templates = em.createQuery(
