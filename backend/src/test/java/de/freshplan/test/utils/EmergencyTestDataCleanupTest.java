 ...
 * 
 * Run this test to see the current state of test data and clean it up.
 * 
 * @author Claude
...
public class EmergencyTestDataCleanupTest {
    ...
    void performCompleteCleanupWithDependencies() {
        ...
        QuarkusTransaction.requiringNew().run(() -> {
            ...
            int deletedCustomerContacts = em.createNativeQuery(
            ...
            int deletedInteractions = em.createNativeQuery(
            ...
            int deletedContacts = em.createNativeQuery(
                "DELETE FROM customer_contacts WHERE customer_id IN " +
                "(SELECT id FROM customers WHERE " +
                "customer_number LIKE 'PF%' OR customer_number LIKE 'PA%' OR " +
                "customer_number LIKE 'PI%' OR customer_number LIKE 'QK%' OR " +
            ...
            int deletedTimeline = em.createNativeQuery(
            ...
            int deletedOpportunities = em.createNativeQuery(
