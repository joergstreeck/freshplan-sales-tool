 ...
 * 
 * All integration tests that create test data should extend this class
 * to ensure proper cleanup and prevent database pollution.
 * 
 * @author Claude
...
public abstract class BaseIntegrationTest {
    ...
    /**
     * Unique test run ID for this test execution.
     * Use this in your test data to make it identifiable for cleanup.
     */
    ...
    /**
     * Hook for subclasses to add additional cleanup logic.
