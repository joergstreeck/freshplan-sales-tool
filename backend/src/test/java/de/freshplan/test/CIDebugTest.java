 ...
 * 
 * WICHTIG: Dieser Test läuft ZUERST (Order 1) um den initialen Zustand zu erfassen!
 */
@QuarkusTest
...
public class CIDebugTest {
    ...
    void debugDatabaseState() {
        ...
        System.out.println("\n### FIRST 10 CUSTOMERS ###");
        customerRepository.findAll().page(0, 10).list().forEach(c -> {
        ...
        System.out.println("\n### DATABASE CONNECTION ###");
        try {
            var ds = customerRepository.getEntityManager()
