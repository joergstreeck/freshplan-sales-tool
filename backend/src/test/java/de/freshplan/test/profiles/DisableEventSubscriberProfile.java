...
/**
 * Test profile that disables the EventSubscriber for isolated testing. Use this profile for tests
 * that mock the EventSubscriber or need to test without background listeners.
 */
