 ...
 *
 * <p>Diese Klasse definiert die Strategie für Test-Datenbanken:
 *
 * <p>1. ISOLATION: Jeder Test läuft in einer isolierten Umgebung 2. STABILITÄT: Seed-Daten bleiben
 * konstant 3. PERFORMANCE: Wiederverwendung von Containern wo möglich
 *
 * @author Claude
...
public class TestDatabaseStrategy {
  ...
  public enum Strategy {
    /**
     * ROLLBACK_AFTER_TEST (Empfohlen für Unit-Tests) - Jeder Test startet mit sauberen Seed-Daten -
     * Alle Änderungen werden nach dem Test zurückgerollt - Schnell und deterministisch
     */
    ROLLBACK_AFTER_TEST,

    /**
     * SEPARATE_SCHEMA (Empfohlen für Integration-Tests) - Jeder Test bekommt sein eigenes Schema -
     * Parallele Test-Ausführung möglich - Keine gegenseitige Beeinflussung
     */
    SEPARATE_SCHEMA,

    /**
     * IN_MEMORY (Schnellste Option) - H2 In-Memory Database - Für einfache Unit-Tests - Keine
     * PostgreSQL-Features
     */
    IN_MEMORY,

    /**
     * TESTCONTAINERS_ISOLATED (Aktuelle Lösung) - Separater PostgreSQL Container - Vollständige
     * Isolation - Realistische Test-Umgebung
     */
