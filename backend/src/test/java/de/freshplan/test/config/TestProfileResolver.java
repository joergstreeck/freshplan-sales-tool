 ...
 *
 * <p>Verhindert Testcontainers in CI und nutzt GitHub Services PostgreSQL.
 */
public class TestProfileResolver {

  /** Detektiert ob wir in CI laufen. */
  public static boolean isCI() {
    return "true".equals(System.getenv("CI")) || "ci".equals(System.getProperty("quarkus.profile"));
  }
