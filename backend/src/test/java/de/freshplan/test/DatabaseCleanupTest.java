...
public class DatabaseCleanupTest {
    ...
    public void analyzeTestData() {
        ...
        customerRepository.find("companyName LIKE ?1", "%Test%")
            .range(0, 10)
            .list()
            .forEach(c -> System.out.println(
                String.format("ID: %s, Number: %s, Name: %s, Created: %s",
    ...
    public void cleanupTestData() {
        ...
        long totalToDelete = toDelete1 + toDelete2 + toDelete3 + toDelete4 + 
                            toDelete5 + toDelete6 + toDelete7 + toDelete8;
