 ...
 *
 * <p>Uses RUN_SUFFIX from CI environment to ensure uniqueness across parallel runs. Falls back to
 * nanoTime for local testing.
 */
public final class UniqueData {
  ...
  /** Generate unique customer number. Format: KD-{RUN}-{UUID} */
