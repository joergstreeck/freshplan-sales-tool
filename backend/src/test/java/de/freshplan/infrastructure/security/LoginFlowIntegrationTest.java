...
/**
 * Integration tests for the complete login flow and authentication scenarios.
 * Tests the interaction between security components, token validation, and API access.
 */
@QuarkusTest
...
class LoginFlowIntegrationTest {
  ...
  class SecurityContextIntegrationTests {
    ...
    @Test
    @TestSecurity(user = "contextuser", roles = {"admin"})
    ...
    @Test
    @TestSecurity(user = "audituser", roles = {"manager"})
  ...
  class CrossComponentIntegrationTests {
    ...
    @Test
    @TestSecurity(user = "integrationuser", roles = {"admin", "manager"})
    ...
    @Test
    @TestSecurity(user = "sessionuser", roles = {"manager"})
  ...
  class ErrorHandlingIntegrationTests {
    ...
    @Test
    @TestSecurity(user = "erroruser", roles = {"sales"})
    ...
    @Test
    @TestSecurity(user = "malformeduser", roles = {"admin"})
    ...
    void malformedRequests_shouldReturn400() {
      given()
          ...
          .post("/api/customers")
          .then()
          .statusCode(anyOf(is(Response.Status.BAD_REQUEST.getStatusCode()),
