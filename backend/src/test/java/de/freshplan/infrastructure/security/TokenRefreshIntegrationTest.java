...
/**
 * Integration tests for token refresh mechanisms and token lifecycle management.
 * Tests the behavior of tokens over time and refresh scenarios.
 */
@QuarkusTest
...
class TokenRefreshIntegrationTest {
  ...
  class TokenLifecycleTests {
    ...
    @Test
    @TestSecurity(user = "tokenuser", roles = {"admin"})
    ...
    @Test
    @TestSecurity(user = "expiryuser", roles = {"manager"})
    ...
    @Test
    @TestSecurity(user = "sessionuser", roles = {"sales"})
    ...
    void multipleRequestsWithSameToken_shouldMaintainSession() {
      ...
      assertEquals(firstResponse, secondResponse, 
          "User information should be consistent across requests");
    }
  }
  ...
  class TokenValidationTests {
    ...
    @Test
    @TestSecurity(user = "validuser", roles = {"admin"})
    ...
    @Test
    @TestSecurity(user = "roleuser", roles = {"invalid_role"})
  ...
  class SecurityContextProviderTests {
    ...
    @Test
    @TestSecurity(user = "contexttest", roles = {"manager"})
    ...
    @Test
    @TestSecurity(user = "authdetailsuser", roles = {"admin", "manager"})
    ...
    @Test
    @TestSecurity(user = "audituser", roles = {"sales"})
  ...
  class ConcurrentAccessTests {
    ...
    @Test
    @TestSecurity(user = "concurrentuser", roles = {"manager"})
    ...
    @Test
    @TestSecurity(user = "heavyuser", roles = {"admin"})
  ...
  class ErrorRecoveryTests {
    ...
    @Test
    @TestSecurity(user = "recoveryuser", roles = {"manager"})
  ...
  class PerformanceTests {
    ...
    @Test
    @TestSecurity(user = "perfuser", roles = {"sales"})
    ...
    @Test
    @TestSecurity(user = "throughputuser", roles = {"manager"})
