 ...
 * 
 * Tests the CQRS-separated ProfileCommandService and ProfileQueryService
 * with Feature Flag enabled to ensure proper delegation and functionality.
 * 
 * Key aspects tested:
 * - Profile creation and updates via CommandService
 * - Profile retrieval and search via QueryService
...
class ProfileCQRSIntegrationTest {
    ...
    @Inject
    ProfileService profileService; // Test via Facade to verify Feature Flag switching
    ...
    void createDuplicateProfile_shouldThrowException() {
        ...
        CreateProfileRequest duplicateRequest = CreateProfileRequest.builder()
            .customerId(testCustomerId)
