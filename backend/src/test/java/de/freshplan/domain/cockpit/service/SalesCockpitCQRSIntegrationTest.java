 ...
 *
 * <p>Tests the Facade pattern with feature flag to ensure: 1. Legacy path works when CQRS is
 * disabled 2. CQRS path works when enabled 3. Both paths return identical results
 *
...
class SalesCockpitCQRSIntegrationTest {
  ...
  @InjectMock SalesCockpitQueryService queryService;
  ...
  void testGetDashboardData_withCqrsDisabled_shouldUseLegacyPath() {
    ...
    when(customerRepository.findActiveCustomersWithoutRecentContact(any()))
