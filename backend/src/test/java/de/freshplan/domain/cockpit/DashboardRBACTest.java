...
/**
 * Test für RBAC-Protection im Event-Publisher.
 * Stellt sicher, dass unauthentifizierte Events nur mit expliziter Config erlaubt sind.
 *
 * Sprint 2.1.1 P1 - RBAC-Security Tests
 */
@QuarkusTest
