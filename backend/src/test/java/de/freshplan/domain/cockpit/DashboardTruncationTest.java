...
/**
 * Test für NOTIFY Payload Truncation.
 * Stellt sicher, dass große Payloads korrekt gekürzt werden.
 *
 * Sprint 2.1.1 P0 HOTFIX - 8KB NOTIFY Limit Handling
 */
@QuarkusTest
class DashboardTruncationTest {
    ...
    void shouldTruncateDataFieldWhenPayloadExceeds8KB() throws Exception {
        ...
        assertThat(testSender.count())
            .as("Ein Event sollte publiziert werden")
            .isEqualTo(1);
        ...
        assertThat(data.getBoolean("truncated"))
            .as("Data sollte als truncated markiert sein")
            .isTrue();
        ...
        assertThat(data.getString("hint"))
            .as("Hint sollte vorhanden sein")
            .contains("8KB");
    }
    ...
    void shouldNotTruncateSmallPayloads() throws Exception {
        ...
        assertThat(data.getBoolean("truncated"))
            .as("Data sollte NICHT truncated sein")
            .isNull();
