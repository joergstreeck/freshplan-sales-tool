...
class CustomerMapperTest {
  ...
  class RequestToEntityMapping {
    ...
    void toEntity_withCreateRequest_shouldMapAllFields() {
      ...
      assertThat(result.getRiskScore())
          .isEqualTo(50); // updateRiskScore() calculates this based on LEAD status
    }
    ...
    void toEntity_withMinimalRequest_shouldApplyDefaults() {
      ...
      assertThat(result.getHierarchyType())
          .isEqualTo(CustomerHierarchyType.STANDALONE); // Default value from entity
      assertThat(result.getIsDeleted()).isFalse(); // Default value from entity
    ...
    void toEntity_withParentCustomerId_shouldHandleParentReference() {
      ...
      CreateCustomerRequest requestWithParent =
          CreateCustomerRequest.builder()
  ...
  class EntityUpdateMapping {
    ...
    void updateEntity_withUpdateRequest_shouldUpdateAllFields() {
      ...
      assertThat(originalCustomer.getHierarchyType())
          .isEqualTo(
              CustomerHierarchyType
                  .STANDALONE); // HierarchyType doesn't update without parent change
      ...
      assertThat(originalCustomer.getExpectedAnnualVolume())
          .isEqualTo(updateRequest.expectedAnnualVolume());
      assertThat(originalCustomer.getActualAnnualVolume())
          .isEqualTo(updateRequest.actualAnnualVolume());
      ...
      assertThat(originalCustomer.getDeliveryCondition())
          .isEqualTo(updateRequest.deliveryCondition());
      assertThat(originalCustomer.getLastContactDate()).isEqualTo(updateRequest.lastContactDate());
      assertThat(originalCustomer.getNextFollowUpDate())
          .isEqualTo(updateRequest.nextFollowUpDate());
    ...
    void updateEntity_withNullValues_shouldHandleGracefully() {
      ...
      assertThat(originalCustomer.getTradingName())
          .isEqualTo("Original Trading"); // Null values in request don't update the field
      assertThat(originalCustomer.getCustomerType()).isEqualTo(CustomerType.UNTERNEHMEN);
      assertThat(originalCustomer.getIndustry())
          .isEqualTo(Industry.HOTEL); // Null values in request don't update the field
