...
class CustomerTimelineRepositoryPerformanceTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        hibernateStats = timelineRepository.getEntityManager()
    ...
    void findByCustomerId_shouldNotCauseN1Queries() {
        ...
        List<CustomerTimelineEvent> events = timelineRepository
                .findByCustomerId(testCustomerId, Page.of(0, 10));

        // Then: Verify results
        assertThat(events).hasSize(10);
        assertThat(events.get(0).getCustomer()).isNotNull();
        assertThat(events.get(0).getCustomer().getCompanyName())
                .isEqualTo("Performance Test Company");
    ...
    void findByCustomerIdAndCategory_shouldNotCauseN1Queries() {
        ...
        List<CustomerTimelineEvent> events = timelineRepository
                .findByCustomerIdAndCategory(testCustomerId, EventCategory.NOTE, Page.of(0, 10));
        ...
        assertThat(executedQueries)
                .as("Should execute only 1 query with JOIN FETCH")
                .isEqualTo(1);
    }
    ...
    void searchByCustomerIdAndText_shouldNotCauseN1Queries() {
        ...
        List<CustomerTimelineEvent> events = timelineRepository
                .searchByCustomerIdAndText(testCustomerId, "Performance", Page.of(0, 10));
    ...
    void countByCustomerId_shouldUseDirectColumnAccess() {
        ...
        assertThat(executedQueries)
                .as("Should execute only 1 count query")
                .isEqualTo(1);
    }
}