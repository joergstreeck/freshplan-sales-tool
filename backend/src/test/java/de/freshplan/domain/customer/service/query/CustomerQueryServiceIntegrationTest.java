 ...
 * 
 * These tests prove that CustomerQueryService behaves IDENTICALLY to CustomerService
 * for all read operations. This is critical for the CQRS migration to ensure
 * no breaking changes when switching via feature flag.
 */
@QuarkusTest
class CustomerQueryServiceIntegrationTest {
    ...
    void getCustomersByStatus_shouldReturnIdenticalResults() {
        ...
        CustomerListResponse fromOriginal = originalService.getCustomersByStatus(CustomerStatus.AKTIV, 0, 10);
    ...
    void getCustomersByIndustry_shouldReturnIdenticalResults() {
        ...
        CustomerListResponse fromOriginal = originalService.getCustomersByIndustry(Industry.HOTEL, 0, 10);
