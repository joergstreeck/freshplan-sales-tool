...
class ContactInteractionServiceTest {
    ...
    @Inject
    ContactInteractionService service;
    ...
    void setUp() {
        ...
        testInteraction = ContactInteraction.builder()
                .contact(testContact)
        ...
        testInteractionDTO = ContactInteractionDTO.builder()
    ...
    void createInteraction_shouldCreateAndUpdateContactMetrics() {
        ...
        when(interactionRepository.find("contact", testContact)).thenReturn(
            new MockPanacheQuery(Arrays.asList(testInteraction))
        );
    ...
    void getDataQualityMetrics_shouldReturnMetrics() {
        ...
        when(contactRepository.count("email is not null and (phone is not null or mobile is not null) and position is not null"))
                .thenReturn(60L);
    ...
    void recordNote_shouldCreateNoteInteraction() {
        ...
        // Then
        assertNotNull(result);
        ArgumentCaptor<ContactInteractionDTO> captor = ArgumentCaptor.forClass(ContactInteractionDTO.class);
    ...
    private ContactInteraction createInteraction(Double sentiment, Integer engagement, String initiatedBy) {
    ...
    private static class MockPanacheQuery implements io.quarkus.hibernate.orm.panache.PanacheQuery<ContactInteraction> {
        ...
        @Override public <T> MockPanacheQuery page(io.quarkus.panache.common.Page page) { return this; }
        @Override public <T> MockPanacheQuery page(int pageIndex, int pageSize) { return this; }
        @Override public <T> MockPanacheQuery nextPage() { return this; }
        @Override public <T> MockPanacheQuery previousPage() { return this; }
        @Override public <T> MockPanacheQuery firstPage() { return this; }
        @Override public <T> MockPanacheQuery lastPage() { return this; }
        @Override public boolean hasNextPage() { return false; }
        @Override public boolean hasPreviousPage() { return false; }
        @Override public int pageCount() { return 1; }
        @Override public io.quarkus.panache.common.Page page() { return null; }
        @Override public <T> MockPanacheQuery range(int startIndex, int lastIndex) { return this; }
        @Override public <T> MockPanacheQuery withCollation(String collation) { return this; }
        @Override public <T> MockPanacheQuery withLock(jakarta.persistence.LockModeType lockModeType) { return this; }
        @Override public <T> MockPanacheQuery withHint(String hintName, Object value) { return this; }
        @Override public <T> MockPanacheQuery filter(String filterName, io.quarkus.panache.common.Parameters params) { return this; }
        @Override public <T> MockPanacheQuery filter(String filterName, java.util.Map<String, Object> params) { return this; }
        @Override public <T> MockPanacheQuery filter(String filterName) { return this; }
        @Override public <T extends Entity> MockPanacheQuery project(Class<T> type) { return this; }
        @Override public <T> java.util.stream.Stream<T> stream() { return (java.util.stream.Stream<T>) results.stream(); }
        @Override public ContactInteraction firstResult() { return results.isEmpty() ? null : results.get(0); }
        @Override public <T> T firstResultOptional() { return (T) java.util.Optional.ofNullable(firstResult()); }
        @Override public ContactInteraction singleResult() { return results.size() == 1 ? results.get(0) : null; }
        @Override public <T> T singleResultOptional() { return (T) java.util.Optional.ofNullable(singleResult()); }
