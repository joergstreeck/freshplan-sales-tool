 ...
 * 
 * CustomerService is the HEART of the application. This test ensures that
 * both implementations (Legacy and CQRS) have IDENTICAL behavior.
 * 
 * Tests all Command and Query operations with Feature Flag enabled:
 * - Commands: create, update, delete, restore, addChild, merge, changeStatus
 * - Queries: get, getAll, getByStatus, getByIndustry, getDashboard, getAtRisk, getHierarchy, checkDuplicates
 * 
...
class CustomerCQRSIntegrationTest {
    ...
    @Inject 
    CustomerResource customerResource; // Test via Resource to verify full stack
    ...
    void getCustomersAtRisk_inCQRSMode_shouldReturnHighRiskCustomers() {
        ...
        var highRiskRequest = CreateCustomerRequest.builder()
        ...
        customerResource.updateCustomer(customerId, 
    ...
    void addChildCustomer_inCQRSMode_shouldCreateHierarchy() {
        ...
        var childResponse = customerResource.createCustomer(
            CreateCustomerRequest.builder()
    ...
    void batchUpdateRiskScores_inCQRSMode_shouldUpdateMultipleCustomers() {
        // Create customers
        var response1 = customerResource.createCustomer(
            CreateCustomerRequest.builder()
        ...
        var response2 = customerResource.createCustomer(
            CreateCustomerRequest.builder()
        ...
        customerResource.updateCustomer(UUID.fromString(customer1.id()),
            UpdateCustomerRequest.builder()
                .status(CustomerStatus.AKTIV) // Low risk - active
                .build()
        );
        
        customerResource.updateCustomer(UUID.fromString(customer2.id()),
            UpdateCustomerRequest.builder()
    ...
    void mergeCustomers_inCQRSMode_shouldMergeData() {
        ...
        var sourceResponse = customerResource.createCustomer(
            CreateCustomerRequest.builder()
        ...
        var targetResponse = customerResource.createCustomer(
            CreateCustomerRequest.builder()
    ...
    void getCustomersByIndustry_inCQRSMode_shouldFilterCorrectly() {
        ...
        // Query by industry
        var healthcareResponse = customerResource.getAllCustomers(0, 100, null, Industry.GESUNDHEITSWESEN);
    ...
    void pagination_inCQRSMode_shouldWorkCorrectly() {
        ...
        // Note: Since we're getting ALL customers (not filtered), pages might overlap with existing data
