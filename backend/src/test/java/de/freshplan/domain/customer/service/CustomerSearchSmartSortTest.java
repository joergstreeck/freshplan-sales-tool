 ...
 * 
 * Tests intelligent sorting strategies like SALES_PRIORITY, RISK_MITIGATION, etc.
 */
@QuarkusTest
...
class CustomerSearchSmartSortTest {
  ...
  void shouldApplyRevenuePotentialStrategy() {
    ...
    BigDecimal lastVolume = result.getContent().get(result.getContent().size() - 1).expectedAnnualVolume();
  ...
  void shouldCombineSmartSortWithGlobalSearch() {
    ...
    assertThat(result.getContent())
        .allMatch(c -> c.companyName().contains("Priority"));
    ...
    if (result.getContent().size() > 1) {
      ...
      BigDecimal last = result.getContent().get(result.getContent().size() - 1).expectedAnnualVolume();
  ...
  private void createCustomersForSalesPriority() {
    Customer highPriority = customerBuilder
    ...
    Customer mediumPriority = customerBuilder
    ...
    Customer lowPriority = customerBuilder
  ...
  private void createCustomersForRiskMitigation() {
    Customer highRisk = customerBuilder
    ...
    Customer mediumRisk = customerBuilder
    ...
    Customer lowRisk = customerBuilder
  ...
  private void createCustomersForEngagementFocus() {
    Customer needsEngagement = customerBuilder
    ...
    Customer recentContact = customerBuilder
    ...
    Customer moderateContact = customerBuilder
  ...
  private void createCustomersForRevenuePotential() {
    Customer highRevenue = customerBuilder
    ...
    Customer mediumRevenue = customerBuilder
    ...
    Customer lowRevenue = customerBuilder
  ...
  private void createCustomersForContactFrequency() {
    Customer oldContact = customerBuilder
  ...
  private void createDiverseCustomers() {
    Customer priority1 = customerBuilder
    ...
    Customer priority2 = customerBuilder
    ...
    Customer noPriority = customerBuilder
