...
class AuditRepositoryTest {
    ...
    void testFindByEntity() {
        ...
        assertThat(entries).extracting(AuditEntry::getEntityType)
                .containsOnly("opportunity");
        assertThat(entries).extracting(AuditEntry::getEntityId)
                .containsOnly(testEntityId);
    }
    ...
    void testFindByUser() {
        ...
        // Then
        assertThat(entries).hasSize(2);
        assertThat(entries).extracting(AuditEntry::getUserId)
    ...
    void testFindSecurityEvents() {
        ...
        assertThat(entries).extracting(AuditEntry::getEventType)
    ...
    void testHashChaining() {
        ...
        AuditEntry secondEntry = allEntries.stream()
