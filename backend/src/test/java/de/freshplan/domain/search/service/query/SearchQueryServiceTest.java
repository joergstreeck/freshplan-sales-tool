 ...
 * 
 * Tests all read-only search operations following established CQRS test patterns:
 * - universalSearch() with various query types  
 * - quickSearch() for autocomplete functionality
 * - Query type detection and relevance scoring
...
class SearchQueryServiceTest {
    ...
    void universalSearch_withCustomerNumberQuery_shouldDetectAndSearchByNumber() {
        ...
        // When
        SearchResults results = searchQueryService.universalSearch(customerNumberQuery, true, false, 20);
