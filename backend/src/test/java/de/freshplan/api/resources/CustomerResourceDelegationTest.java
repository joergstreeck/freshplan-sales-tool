...
/**
 * Pure unit test for CustomerResource delegation logic using reflection.
 * Tests feature flag behavior without Quarkus container.
 *
 * This test validates that the correct service (legacy vs CQRS) is called
 * based on feature flag settings. It uses reflection to bypass security
...
class CustomerResourceDelegationTest {
    ...
    @Test
    @DisplayName("Should use legacy for list when per-use-case flag disabled (performance optimization)")
