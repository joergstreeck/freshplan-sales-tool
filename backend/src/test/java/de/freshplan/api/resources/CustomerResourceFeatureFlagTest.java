 ...
 *
 * <p>This is a unit test that ensures the delegation logic works correctly. Tests both global CQRS
...
class CustomerResourceFeatureFlagTest {
  ...
  @Inject CustomerResource customerResource;

  @InjectMock CustomerService customerService;

  @InjectMock CustomerCommandService commandService;

  @InjectMock CustomerQueryService queryService;
