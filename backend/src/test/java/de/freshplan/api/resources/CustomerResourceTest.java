...
/**
 * Integration tests for CustomerResource REST API.
...
class CustomerResourceTest {
    ...
    void setUp() {
        ...
        Map<CustomerStatus, Long> statusCounts = Map.of(
                CustomerStatus.LEAD, 20L,
                CustomerStatus.AKTIV, 85L,
                CustomerStatus.RISIKO, 8L
        );
        
        Map<CustomerLifecycleStage, Long> lifecycleCounts = Map.of(
                CustomerLifecycleStage.ACQUISITION, 55L,
                CustomerLifecycleStage.GROWTH, 60L
        );

        dashboardResponse = new CustomerDashboardResponse(
                150L, // totalCustomers
    ...
    class CrudOperations {
        ...
        void createCustomer_withValidRequest_shouldReturn201() {
            // Given
            when(customerService.createCustomer(org.mockito.ArgumentMatchers.any(CreateCustomerRequest.class), eq("system")))
            ...
            verify(customerService).createCustomer(org.mockito.ArgumentMatchers.any(CreateCustomerRequest.class), eq("system"));
        }
        ...
        void updateCustomer_withValidRequest_shouldReturn200() {
            // Given
            UUID customerId = UUID.randomUUID();
            when(customerService.updateCustomer(eq(customerId), org.mockito.ArgumentMatchers.any(UpdateCustomerRequest.class), eq("system")))
                    .thenReturn(customerResponse);
            ...
            verify(customerService).updateCustomer(eq(customerId), org.mockito.ArgumentMatchers.any(UpdateCustomerRequest.class), eq("system"));
        }
        ...
        void deleteCustomer_withChildren_shouldReturn400() {
            ...
            doThrow(new CustomerHasChildrenException(customerId, "delete"))
                    .when(customerService).deleteCustomer(eq(customerId), eq("system"), any());
    ...
    class ListAndSearchOperations {
        ...
        void getAllCustomers_withIndustryFilter_shouldReturn200() {
            ...
            when(customerService.getCustomersByIndustry(industry, 0, 20)).thenReturn(customerListResponse);
    ...
    class AnalyticsAndDashboard {
        ...
        void getCustomersAtRisk_shouldReturn200() {
            // Given
            int minRiskScore = 70;
            when(customerService.getCustomersAtRisk(minRiskScore, 0, 20)).thenReturn(customerListResponse);
        ...
        @Test
        @DisplayName("GET /api/customers/analytics/risk-assessment - Should validate risk score parameter")
    ...
    class HierarchyManagement {
        ...
        void addChildCustomer_withValidIds_shouldReturn200() {
            ...
            when(customerService.addChildCustomer(parentId, childId, "system")).thenReturn(customerResponse);
    ...
    class UtilityOperations {
        ...
        void mergeCustomers_withValidIds_shouldReturn200() {
            ...
            when(customerService.mergeCustomers(targetId, sourceId, "system")).thenReturn(customerResponse);
        ...
        void changeCustomerStatus_withValidStatus_shouldReturn200() {
            ...
            when(customerService.changeStatus(customerId, newStatus, "system")).thenReturn(customerResponse);
    ...
    class ErrorHandling {
        ...
        void handleCustomerAlreadyExistsException_shouldReturn409() {
            // Given
            when(customerService.createCustomer(org.mockito.ArgumentMatchers.any(CreateCustomerRequest.class), any()))
