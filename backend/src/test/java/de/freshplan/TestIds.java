 ...
 *
 * <p>Sprint 2.1.4 - Ensures collision-free test data generation.
 */
public final class TestIds {
  ...
  /**
   * Generates a stable customer number within a test run per test method (reproducible). Useful
   * when tests need to reference the same number multiple times.
   *
  ...
  /**
   * Legacy fixed customer number for backward compatibility. Only use for tests that explicitly
   * require this specific value.
   *
