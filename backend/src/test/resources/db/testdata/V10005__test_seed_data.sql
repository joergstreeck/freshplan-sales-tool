...
BEGIN
  ...
  INSERT INTO customers (
      ...
      -- Scenario 1-5: Active customers (is_test_data=false to protect from cleanup!)
      ...
      -- Scenario 6-10: Risk and inactive customers (is_test_data=false to protect from cleanup!)
      ...
      -- Scenario 11-15: Leads and prospects (is_test_data=false to protect from cleanup!)
      ...
      -- Scenario 16-20: Edge cases (is_test_data=false to protect from cleanup!)
  ...
  ON CONFLICT (customer_number) DO UPDATE
    SET is_test_data = FALSE,  -- Protect SEED data from cleanup
