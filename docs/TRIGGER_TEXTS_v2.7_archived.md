...
(Universelles Script - funktioniert aus JEDEM Verzeichnis!
 Wählt automatisch das beste verfügbare Handover-Script:
...
Lese alles gründlich durch und befolge strict die Standardübergabe.
    ...
    🚨🚨🚨 MIGRATION ALERT - IMMER PRÜFEN! 🚨🚨🚨
    ./scripts/get-next-migration.sh
    → Zeigt die nächste freie Migration-Nummer
    → Funktioniert aus jedem Verzeichnis (robust seit 08.08.2025)
    → Bei Migration-Arbeit ohne klare Nummer: SESSION UNTERBRECHEN!
