...
**Empfehlung:** Option 1 (Sprint 2.1.7.2) - Logische Fortsetzung nach Sprint 2.1.7.1, User-Story durchgängig (Lead → Opportunity → Customer), Xentral-Doku bereits vollständig vorhanden.
