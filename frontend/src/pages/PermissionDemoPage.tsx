            ...
            <CardContent>
              <Box display="flex" alignItems="center" justifyContent="space-between" mb={2}>
                <Box display="flex" alignItems="center">
                  ...
                  <Typography variant="h6">Benutzerberechtigungen ({permissions.size})</Typography>
                </Box>
                <PermissionButton
              ...
              {permissions.size === 0 ? (
                <Typography color="text.secondary">Keine Berechtigungen geladen</Typography>
              ) : (
            ...
            <CardContent>
              ...
              <Box display="flex" flexDirection="column" gap={2}>
                ...
                <Alert severity="info" variant="outlined">
                  Buttons werden automatisch ausgeblendet, wenn dem Benutzer die erforderlichen
                ...
                {testPermissions.map(permission => (
                  <Grid item key={permission}>
                    <PermissionGate
                      ...
                      fallback={
                        <Chip label={permission} color="default" variant="outlined" size="small" />
                      }
                    >
                      <Chip label={permission} color="success" size="small" />
                    </PermissionGate>
                  </Grid>
                ))}
              </Grid>
