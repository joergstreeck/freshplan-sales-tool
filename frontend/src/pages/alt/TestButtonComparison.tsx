...
import { Button as ShadcnButton } from '../components/ui/button'; // ⚠️ ALTER SHADCN BUTTON - NUR FÜR TEST!
...
export function TestButtonComparison() {
  return (
    <div style={{ padding: '2rem', background: '#f5f5f5' }}>
      ...
      >
        <p>
          <strong>Hinweis:</strong> Die FreshPlan-Buttons nutzen unsere CI-Farben (#94C456 für Grün,
          #004F7B für Blau)
        </p>
      </div>
    </div>
