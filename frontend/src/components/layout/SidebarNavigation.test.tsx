...
describe('SidebarNavigation', () => {
  ...
  it('expands submenu when parent is clicked', () => {
    ...
    expect(mockNavigationStore.toggleSubmenu).toHaveBeenCalledWith(expect.any(String));
  });
  ...
  it('auto-expands submenu when on sub-page', () => {
    // Test is handled by useEffect in component
    // Would need to test with different route paths
  });
