...
describe('AuditDashboard', () => {
  ...
  it.skip('should show compliance status chip with correct color', () => {
    renderComponent();
  ...
  it.skip('should apply FreshFoodz theme colors', () => {
    renderComponent();
  ...
  it.skip('should use Antonio font for headers', () => {
    renderComponent();
  ...
  it.skip('should use Poppins font for body text', () => {
    renderComponent();
  ...
  it.skip('should display event type chips with correct styling', () => {
    renderComponent();

    const chips = screen.getAllByText(/\d+/).filter(el => el.classList.contains('MuiChip-label'));
  ...
  it.skip('should show border between event type items', () => {
    renderComponent();

    const eventTypeSection = screen.getByText('Top Ereignistypen').closest('.MuiPaper-root');

    const items = within(eventTypeSection!)
  ...
  it.skip('should handle invalid integrity status', () => {
  ...
  it.skip('should display all grid items with correct spacing', () => {
  ...
  it.skip('should use responsive grid layout', () => {
    const { container } = renderComponent();
  ...
  it.skip('should show zero state for metrics', () => {
    const zeroMetrics = {
      ...mockMetrics,
      totalEventsToday: 0,
      activeUsers: 0,
