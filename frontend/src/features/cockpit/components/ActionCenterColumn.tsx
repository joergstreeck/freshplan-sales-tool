...
export function ActionCenterColumn() {
  ...
  // Lade Dashboard-Daten vom BFF mit echter oder Fallback-User-ID
        ...
        <div className="column-content">
          ...
          <div className="column-empty">
            ...
            <p className="column-empty-description">
              Wählen Sie einen Kunden aus der Fokus-Liste aus, um mit kundenspezifischen Aktionen zu
              beginnen.
            </p>
          </div>
        </div>
  ...
  return (
    <div className="action-center-column">
      ...
      <div className="column-content">
        {/* Dashboard Statistiken */}
        {dashboardData && (
          <DashboardStats statistics={dashboardData.statistics} loading={isLoading} error={error} />
        )}
            ...
            return (
              <section className="process-content">
                <div className="process-header">
                  <h3 className="process-title">{activeProcessData?.name}</h3>
                ...
                <div className="process-placeholder">
                  <p>
                    Hier werden die geführten Schritte für den Prozess "{activeProcessData?.name}"
                    angezeigt.
                  </p>
