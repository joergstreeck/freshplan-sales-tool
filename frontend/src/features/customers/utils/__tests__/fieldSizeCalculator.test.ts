...
describe('fieldSizeCalculator', () => {
  ...
  describe('calculateOptimalRows', () => {
    it('should create balanced rows summing to 12', () => {
      const fields: FieldDefinition[] = [
        { key: 'postalCode', label: 'PLZ', fieldType: 'text', entityType: 'customer', required: true }, // 2
        { key: 'city', label: 'Stadt', fieldType: 'text', entityType: 'customer', required: true }, // 4
        { key: 'country', label: 'Land', fieldType: 'text', entityType: 'customer', required: true }, // 4
      ];
    ...
    it('should split fields into multiple rows when exceeding 12', () => {
      const fields: FieldDefinition[] = [
        { key: 'email', label: 'E-Mail', fieldType: 'email', entityType: 'customer', required: true }, // 8
        { key: 'phone', label: 'Telefon', fieldType: 'text', entityType: 'customer', required: true }, // 4
        { key: 'mobile', label: 'Mobil', fieldType: 'text', entityType: 'customer', required: false }, // 4
      ];
    ...
    it('should handle full-width fields correctly', () => {
      const fields: FieldDefinition[] = [
        { key: 'firstName', label: 'Vorname', fieldType: 'text', entityType: 'customer', required: true }, // 4
        { key: 'notes', label: 'Notizen', fieldType: 'textarea', entityType: 'customer', required: false }, // 12
        { key: 'lastName', label: 'Nachname', fieldType: 'text', entityType: 'customer', required: true }, // 4
      ];
  ...
  describe('debugFieldLayout', () => {
    it('should produce readable debug output', () => {
      const fields: FieldDefinition[] = [
        { key: 'postalCode', label: 'PLZ', fieldType: 'text', entityType: 'customer', required: true, maxLength: 5 },
        { key: 'city', label: 'Stadt', fieldType: 'text', entityType: 'customer', required: true, maxLength: 50 },
        { key: 'country', label: 'Land', fieldType: 'text', entityType: 'customer', required: true, maxLength: 50 },
        { key: 'email', label: 'E-Mail', fieldType: 'email', entityType: 'customer', required: true }
      ];
