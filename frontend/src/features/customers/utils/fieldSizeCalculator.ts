...
export function getFieldSize(field: FieldDefinition): GridSize {
  ...
  switch (field.fieldType) {
    ...
    case 'dropdown':
      ...
      return field.options && field.options.length > 10 ? FIELD_THEME.medium : FIELD_THEME.small;
    ...
    case 'radio':
      return field.options && field.options.length > 3 ? FIELD_THEME.medium : FIELD_THEME.small;
