        ...
        return [
          {
            ...
            icon: '🏥',
            fields: [
              { key: 'mealSystem', label: 'Verpflegungssystem', fieldType: 'select', 
                options: [
          ...
          },
          {
            ...
            icon: '🥗',
            fields: [
              { key: 'offersVegetarian', label: 'Vegetarisch', fieldType: 'select', options: [
                { value: false, label: 'Nein' }, { value: true, label: 'Ja' }
              ]},
              { key: 'offersVegan', label: 'Vegan', fieldType: 'select', options: [
                { value: false, label: 'Nein' }, { value: true, label: 'Ja' }
              ]},
              { key: 'offersHalal', label: 'Halal', fieldType: 'select', options: [
                { value: false, label: 'Nein' }, { value: true, label: 'Ja' }
              ]},
              { key: 'offersKosher', label: 'Koscher', fieldType: 'select', options: [
                { value: false, label: 'Nein' }, { value: true, label: 'Ja' }
              ]}
            ] as FieldDefinition[]
          }
        ...
        return [
          {
            ...
            icon: '🏢',
            fields: [
              { key: 'operatingDays', label: 'Betriebstage/Woche', fieldType: 'number', min: 1, max: 7 },
              { key: 'lunchGuests', label: 'Mittagsgäste/Tag', fieldType: 'number' },
              { key: 'subsidized', label: 'Subventioniert', fieldType: 'select', options: [
                { value: false, label: 'Nein' }, { value: true, label: 'Ja' }
              ]}
            ] as FieldDefinition[]
          }
