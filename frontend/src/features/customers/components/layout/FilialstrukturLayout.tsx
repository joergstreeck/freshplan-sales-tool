...
export const FilialstrukturLayout: React.FC<FilialstrukturLayoutProps> = ({
  ...
  const sortedFields = fieldOrder.map(key => 
    ...
    <Box>
      ...
      <LabelsContainer>
        {sortedFields.map(field => {
          ...
          const labelClass = field.fieldType === 'number' 
            ? 'label-number-compact' 
          ...
          return (
            ...
            >
              <FieldLabel data-required={field.required}>
                {field.label}
              </FieldLabel>
      ...
      <InputsContainer>
        {sortedFields.map(field => {
          // CSS-Klasse basierend auf Feldtyp
          const fieldClass = field.fieldType === 'number'
            ? 'field-number-compact'
            : (field.fieldType === 'select' || field.fieldType === 'dropdown') 
            ? 'field-dropdown-auto' 
            : '';
