...
describe('PaymentBehaviorIndicator', () => {
  describe('Payment Behavior Classification', () => {
    it('renders EXCELLENT (≤7 days) with success alert', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="EXCELLENT" averageDaysToPay={7} />);
    ...
    it('renders GOOD (8-14 days) with info alert', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="GOOD" averageDaysToPay={12} />);
    ...
    it('renders WARNING (15-30 days) with warning alert', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="WARNING" averageDaysToPay={25} />);
    ...
    it('renders CRITICAL (>30 days) with error alert', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="CRITICAL" averageDaysToPay={45} />);
    ...
    it('renders N_A (no data) with info alert', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="N_A" averageDaysToPay={null} />);
  ...
  describe('Edge Cases', () => {
    it('renders N_A when averageDaysToPay is null', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="GOOD" averageDaysToPay={null} />);
    ...
    it('rounds averageDaysToPay to integer', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="GOOD" averageDaysToPay={13.7} />);
    ...
    it('handles zero days correctly', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="EXCELLENT" averageDaysToPay={0} />);
  ...
  describe('Localization', () => {
    it('uses German labels', () => {
      renderWithTheme(<PaymentBehaviorIndicator behavior="EXCELLENT" averageDaysToPay={5} />);
