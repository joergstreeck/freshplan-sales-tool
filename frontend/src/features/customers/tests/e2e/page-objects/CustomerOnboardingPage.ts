...
export class CustomerOnboardingPage {
  ...
  constructor(page: Page) {
    ...
    this.previousButton = page.locator('button:has-text("Zurück"), [data-testid="previous-button"]');
    this.saveButton = page.locator('button:has-text("Speichern"), button:has-text("Abschließen"), [data-testid="save-button"]');
    ...
    this.chainCustomerSelect = page.locator('select[name="chainCustomer"], [data-testid="chain-customer-select"]');
    ...
    this.employeeCountField = page.locator('input[name="employeeCount"], [data-testid="employee-count"]');
    this.bedCountField = page.locator('input[name="bedCount"], [data-testid="bed-count"]');
    
    // Step 2 - Locations
    this.addLocationButton = page.locator('button:has-text("Standort hinzufügen"), [data-testid="add-location"]');
    this.locationNameField = page.locator('input[name*="location"][name*="name"], [data-testid*="location-name"]');
    this.locationStreetField = page.locator('input[name*="location"][name*="street"], [data-testid*="location-street"]');
    this.locationPostalCodeField = page.locator('input[name*="location"][name*="postalCode"], [data-testid*="location-postal"]');
    this.locationCityField = page.locator('input[name*="location"][name*="city"], [data-testid*="location-city"]');
    this.locationContactPersonField = page.locator('input[name*="location"][name*="contactPerson"], [data-testid*="location-contact"]');
    this.locationPhoneField = page.locator('input[name*="location"][name*="phone"], [data-testid*="location-phone"]');
    this.locationEmailField = page.locator('input[name*="location"][name*="email"], [data-testid*="location-email"]');
    this.removeLocationButton = page.locator('button:has-text("Entfernen"), [data-testid*="remove-location"]');
    
    // Step 3 - Detailed Locations
    this.addDetailedLocationButton = page.locator('button:has-text("Detail hinzufügen"), [data-testid="add-detailed-location"]');
    this.detailedLocationNameField = page.locator('input[name*="detailed"][name*="name"], [data-testid*="detailed-name"]');
    this.detailedLocationCategorySelect = page.locator('select[name*="detailed"][name*="category"], [data-testid*="detailed-category"]');
    this.detailedLocationFloorField = page.locator('input[name*="detailed"][name*="floor"], [data-testid*="detailed-floor"]');
    this.detailedLocationCapacityField = page.locator('input[name*="detailed"][name*="capacity"], [data-testid*="detailed-capacity"]');
    this.detailedLocationHoursField = page.locator('input[name*="detailed"][name*="hours"], [data-testid*="detailed-hours"]');
    this.detailedLocationResponsibleField = page.locator('input[name*="detailed"][name*="responsible"], [data-testid*="detailed-responsible"]');
    this.detailedLocationInternalPhoneField = page.locator('input[name*="detailed"][name*="internalPhone"], [data-testid*="detailed-internal-phone"]');
    this.detailedLocationRequirementsField = page.locator('textarea[name*="detailed"][name*="requirements"], [data-testid*="detailed-requirements"]');
  ...
  async addLocation(locationData: any, index: number = 0) {
    ...
    const nameField = this.page.locator(`[data-testid="location-name-${index}"], input[name="locations[${index}].name"]`);
    const streetField = this.page.locator(`[data-testid="location-street-${index}"], input[name="locations[${index}].street"]`);
    const postalCodeField = this.page.locator(`[data-testid="location-postal-${index}"], input[name="locations[${index}].postalCode"]`);
    const cityField = this.page.locator(`[data-testid="location-city-${index}"], input[name="locations[${index}].city"]`);
    const contactField = this.page.locator(`[data-testid="location-contact-${index}"], input[name="locations[${index}].contactPerson"]`);
    const phoneField = this.page.locator(`[data-testid="location-phone-${index}"], input[name="locations[${index}].phone"]`);
    const emailField = this.page.locator(`[data-testid="location-email-${index}"], input[name="locations[${index}].email"]`);
  ...
  async expectValidationError(fieldName: string, errorMessage: string) {
    const errorElement = this.page.locator(`[data-testid="${fieldName}-error"], .error:has-text("${errorMessage}")`);
  ...
  async expectAriaLabels() {
    ...
    expect(companyNameLabel || await this.page.locator('label[for*="companyName"]').textContent()).toBeTruthy();
    expect(industryLabel || await this.page.locator('label[for*="industry"]').textContent()).toBeTruthy();
  }
