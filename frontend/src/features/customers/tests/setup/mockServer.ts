...
export const handlers = [
  ...
  rest.get('/api/field-definitions', (req, res, ctx) => {
    ...
    return res(ctx.status(200), ctx.json(fields), ctx.delay(50));
  }),
  ...
  rest.get('/api/field-definitions/:id', (req, res, ctx) => {
    ...
    return res(ctx.status(200), ctx.json(field));
  }),
  ...
  rest.post('/api/customers/drafts', (req, res, ctx) => {
    ...
    return res(ctx.status(201), ctx.json(draft), ctx.delay(100));
  }),
  ...
  rest.put('/api/customers/drafts/:draftId', async (req, res, ctx) => {
    ...
    return res(ctx.status(200), ctx.json(draft));
  }),
  ...
  rest.post('/api/customers/drafts/:draftId/finalize', async (req, res, ctx) => {
    ...
    return res(ctx.status(201), ctx.json(customer), ctx.delay(150));
  }),
  ...
  rest.get('/api/customers', (req, res, ctx) => {
    ...
    if (search) {
      customers = customers.filter(
        c =>
          c.name.toLowerCase().includes(search.toLowerCase()) || c.customerNumber.includes(search)
      );
    }
