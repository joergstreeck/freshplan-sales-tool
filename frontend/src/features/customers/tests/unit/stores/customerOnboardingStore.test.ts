...
describe('CustomerOnboardingStore - Field Management (mit Flexibilitäts-Philosophie)', () => {
  beforeEach(() => {
    localStorage.clear();
  ...
  describe('✅ Flexible Field Values (KERNFEATURE)', () => {
  ...
  describe('🏢 Branchenspezifische Dynamik', () => {
    it('should handle different industry field structures', () => {
      ...
      act(() => {
        ...
        result.current.setCustomerField('fachabteilungen', ['Kardiologie', 'Neurologie', 'Chirurgie']);
  ...
  describe('📍 Location Management', () => {
    it('should manage locations with flexible field values', () => {
      ...
      expect(result.current.locationFieldValues[location2Id].openingHours.monday).toBe('08:00-18:00');
    });
  ...
  describe('📝 Detailed Locations Management', () => {
  ...
  describe('✅ Validation mit Field Definitions', () => {
