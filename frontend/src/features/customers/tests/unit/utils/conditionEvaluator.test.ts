...
describe.skip('ConditionEvaluator - Mit Flexibilitäts-Philosophie', () => {
  describe.skip('✅ evaluateCondition - Dynamische Bedingungen', () => {
  ...
  describe.skip('🔄 shouldShowWizardStep - Wizard Flow Logic', () => {
    ...
    it('should show step when multiple trigger options exist', () => {
      ...
      expect(
        shouldShowWizardStep('specialFields', fieldDefinitions, {
          industry: 'hotel',
        })
      ).toBe(true);
    ...
    it('should handle dynamic field definitions with complex triggers', () => {
      ...
      expect(
        shouldShowWizardStep('enterpriseFeatures', dynamicFieldDefinitions, {
  ...
  describe.skip('👁️ getVisibleFields - Dynamic Field Visibility', () => {
  ...
  describe.skip('📋 getRequiredFields - Dynamic Required Fields', () => {
