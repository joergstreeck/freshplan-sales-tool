...
// statt den useOpportunities Hook. Die Component muss refactored werden,
// um testbar zu sein. Dieser Mock hat daher keine Wirkung.
...
describe('KanbanBoardDndKit', () => {
  ...
  it.todo('shows loading state when data is being fetched');
});