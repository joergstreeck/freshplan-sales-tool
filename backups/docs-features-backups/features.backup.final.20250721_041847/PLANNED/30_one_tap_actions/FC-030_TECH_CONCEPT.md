...
- **[📱 FC-018 Mobile PWA](/docs/features/PLANNED/22_mobile_light/FC-018_TECH_CONCEPT.md)** - Mobile One-Tap Actions
...
- **[⚙️ M7 Settings](/docs/features/ACTIVE/05_ui_foundation/M7_TECH_CONCEPT.md)** - Quick Action Konfiguration

### 🔧 Technische Details:
- **[IMPLEMENTATION_BACKEND.md](/docs/features/ACTIVE/01_security/IMPLEMENTATION_BACKEND.md)** *(geplant)* - Backend-Services
- **[IMPLEMENTATION_FRONTEND.md](/docs/features/ACTIVE/01_security/IMPLEMENTATION_FRONTEND.md)** *(geplant)* - React Components
- **[DECISION_LOG.md](/docs/features/ACTIVE/01_security/DECISION_LOG.md)** *(geplant)* - Architektur-Entscheidungen
