  ...
  constructor(rules?: Partial<DiscountRulesConfig>) {
    ...
    this.scenarios = new Map([
      ['spontaneous', {
        ...
        pickup: false,
        chain: false,
        description: 'Spontaneous order with minimal lead time'
      }],
      ['planned', {
        name: 'planned',
        orderValue: 25000,
        ...
        pickup: false,
        chain: false,
        description: 'Well-planned order with moderate volume'
      }],
      ['optimal', {
        name: 'optimal',
        orderValue: 50000,
        ...
        pickup: true,
        chain: false,
        description: 'Optimal scenario with all discounts'
      }]
    ]);
  }
