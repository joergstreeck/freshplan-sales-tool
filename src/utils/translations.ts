...
export const translations: Record<Language, any> = {
  de: {
    ...
    info: {
      chain: {
        title: 'Kettenkunden',
        description: 'Bei Kettenkunden profitieren Sie von der Bündelung mehrerer Standorte.'
      },
      pickup: {
        title: 'Abholung',
        description: 'Bei Selbstabholung sparen Sie zusätzlich 2% (ab 5.000€).'
      },
      scale: {
        title: 'Rabattstaffel'
      }
    ...
    customer: {
      ...
      residents: 'Bewohner',
      krankenhausSpecific: 'Klinik Details',
      beds: 'Betten',
  ...
  en: {
    ...
    customer: {
      ...
      selectLegalForm: 'Please select',
      gmbh: 'GmbH',
      ag: 'AG',
      gbr: 'GbR',
      einzelunternehmen: 'Sole Proprietorship',
      other: 'Other',
      customerStatus: 'Customer Type',
      newCustomer: 'New Customer',
      existingCustomer: 'Existing Customer',
      customerNumber: 'Customer Number (internal)',
      annualVolume: 'Expected Annual Volume',
